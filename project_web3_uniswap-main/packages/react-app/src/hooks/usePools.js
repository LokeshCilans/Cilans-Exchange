...
export const usePools = () => {
  ...
  console.log("readOnlyChainId",readOnlyChainId)
  console.log("readOnlyUrls",readOnlyUrls)
  console.log("readOnlyUrls[readOnlyChainId]",readOnlyUrls[readOnlyChainId])
